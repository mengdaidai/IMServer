...
public class Protocol {
	...
	public static final byte TRANSMITION_RESPONSE_TYPE = 11;//登录后对文件接收的回应
	public static final byte FILE_TYPE = 12;//来自客户端的文件发送请求
	public static final byte FILE_TRANS_TYPE = 13;//暂时没用
	public static final byte FILE_RESPONSE_TYPE = 14;//在线传输回应
